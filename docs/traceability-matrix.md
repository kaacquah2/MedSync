...
| FR-05 | Break-the-glass (reason + re-MFA + time-boxed + audited) | `access/views.py::break_glass_request`; `access/models.py::BreakGlassAccess`; `access/forms.py::BreakGlassForm` | `tests/test_access.py::TestBreakGlassRequest` |
