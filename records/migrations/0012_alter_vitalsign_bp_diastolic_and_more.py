...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    ...
                    models.Q(("temperature__gte", 30.0), ("temperature__lte", 45.0)),
                    _connector="OR",
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    ("bp_systolic__isnull", True),
                    models.Q(("bp_systolic__gte", 50), ("bp_systolic__lte", 250)),
                    _connector="OR",
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    ("bp_diastolic__isnull", True),
                    models.Q(("bp_diastolic__gte", 30), ("bp_diastolic__lte", 150)),
                    _connector="OR",
                ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    ("spo2__isnull", True),
                    models.Q(("spo2__gte", 50), ("spo2__lte", 100)),
                    _connector="OR",
                ),
